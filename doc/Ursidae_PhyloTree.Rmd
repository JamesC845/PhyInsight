---
title: "Phylogenetic Tree of the Ursidae Family"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Ursidae_PhyloTree}
...
Any taxon can be used provided the DNA strings are in the correct format. The Ursidae family will be used as an example.
...
```{r, fig.show='hold', fig.width=12, fig.height=10}
# plot the phylo tree
plot(
  PhyloTree,
  label.offset = 0.001,

---
title: "Automated String Clean Up with rmBadStrings()"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{PhyloTree_vignette_2}
...
The `rmBadStrings` functions (`rmBadStrings_1()`, `rmBadStrings_2()`, and  `rmBadStrings_3()`) can be used to automatically clean a DNA string set that would otherwise be unsuitable for analysis. These functions automatically remove strings that are mismatched with other strings and those whose distances return `NaN` values or are considered outliers.
